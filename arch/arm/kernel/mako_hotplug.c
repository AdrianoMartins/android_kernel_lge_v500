...
#define DEFAULT_LOAD_THRESHOLD 87
#define DEFAULT_HIGH_LOAD_COUNTER 17
#define DEFAULT_MAX_LOAD_COUNTER 12
#define DEFAULT_CPUFREQ_UNPLUG_LIMIT 1300000
#define DEFAULT_MIN_TIME_CPU_ONLINE 1
#define DEFAULT_TIMER 2
...
static DEVICE_ATTR(high_load_counter, 0664, high_load_counter_show, high_load_counter_store);
static DEVICE_ATTR(max_load_counter, 0664, max_load_counter_show, max_load_counter_store);
static DEVICE_ATTR(cpufreq_unplug_limit, 0664, cpufreq_unplug_limit_show, cpufreq_unplug_limit_store);
static DEVICE_ATTR(min_time_cpu_online, 0664, min_time_cpu_online_show, min_time_cpu_online_store);
